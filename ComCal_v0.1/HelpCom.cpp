...
HelpCom::HelpCom(Manipulator* todoTMPtr, Manipulator* doneTMPtr) : Command(todoTMPtr, doneTMPtr) {
}


HelpCom::~HelpCom(void) {
}

std::string HelpCom::executeInput(std::string userInput) {
	std::string feedback;
